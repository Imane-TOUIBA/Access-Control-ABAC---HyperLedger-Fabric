...
const CRYPTO_PATH = path.join(TEST_NETWORK_HOME, 'organizations', 'peerOrganizations', 'cgn.example.com');

const KEY_DIRECTORY_PATH = path.join(CRYPTO_PATH, 'users', 'User1@cgn.example.com', 'msp', 'keystore');
const CERT_DIRECTORY_PATH = path.join(CRYPTO_PATH, 'users', 'User1@cgn.example.com', 'msp', 'signcerts');
